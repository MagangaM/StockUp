...
<?php $__env->startSection('adminlte_js'); ?>
    ...
    <?php if(($message=Session::get('message')) && ($icon=Session::get('icon'))): ?>
        <script>
        Swal.fire({
            position: "center",
...
<?php echo $__env->make('adminlte::master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Stockup\resources\views/vendor/adminlte/page.blade.php ENDPATH**/ ?>