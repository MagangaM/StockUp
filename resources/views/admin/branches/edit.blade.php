                ...
                <div class="card-body" style="display:block">
                    <form action="{{ url('/admin/branch/'.$branch->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Branch Name</label>
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter the name of the branch" value="{{ $branch->name }}" required>
                                        @error ('name')
                                ...
                                <div class="form-group">
                                    <label for="name">Branch Address</label>
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ $branch->address }}" class="form-control" id="address" name="address" placeholder="Enter the address of the branch" required>
                                            @error ('name')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="name">Branch Phone Number</label>
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ $branch->phonenumber }}" class="form-control" id="phonenumber" name="phonenumber" placeholder="Enter the phone number of the branch" required>
                                            @error ('name')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="{{ url('/admin/branches') }}" class="btn btn-danger">Cancel</a>
