                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="<?php echo e(old('observation')); ?>" class="form-control" id="observation" name="observation" placeholder="Enter the observations made during the purchase">
                                    </div>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Stockup\resources\views/admin/purchases/edit.blade.php ENDPATH**/ ?>