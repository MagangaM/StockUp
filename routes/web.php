...
Route::get('/admin/supplier/{id}/edit', [App\Http\Controllers\SupplierController::class, 'edit'])->name('suppliers.edit')->middleware('auth');
...
Route::get('/admin/purchases', [App\Http\Controllers\PurchaseController::class, 'index'])->name('purchases.index')->middleware('auth');
Route::get('/admin/purchases/create', [App\Http\Controllers\PurchaseController::class, 'create'])->name('purchases.create')->middleware('auth');
Route::post('/admin/purchases/create', [App\Http\Controllers\PurchaseController::class, 'store'])->name('purchases.store')->middleware('auth');
Route::get('/admin/purchase/{id}', [App\Http\Controllers\PurchaseController::class, 'show'])->name('purchases.show')->middleware('auth');
Route::get('/admin/purchase/{id}/edit', [App\Http\Controllers\PurchaseController::class, 'edit'])->name('purchases.edit')->middleware('auth');
Route::put('/admin/purchase/{id}', [App\Http\Controllers\PurchaseController::class, 'update'])->name('purchases.update')->middleware('auth');
Route::delete('/admin/purchase/{id}', [App\Http\Controllers\PurchaseController::class, 'destroy'])->name('purchases.destroy')->middleware('auth');
