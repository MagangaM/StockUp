                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group-sm" role="group" aria-label="Basic example">
                                                <a href="<?php echo e(url('/admin/branches/'.$branch->id)); ?>" class="btn btn-info"><i class="fas fa-eye"> View</i></a>
                                                <a href="<?php echo e(url('/admin/branches/'.$branch->id.'/edit')); ?>" class="btn btn-success"><i class="fas fa-pencil-alt"> Edit</i></a>
                                                <form action="<?php echo e(url('/admin/branches/'.$branch->id)); ?>" id= "myform<?php echo e($branch->id); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
